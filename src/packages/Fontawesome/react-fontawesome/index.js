(function (global, factory) {
    ...
    function convert(createElement, element) {
        ...
        return createElement.apply(
            void 0,
            [element.tag, _objectSpread2({}, mixins.attrs, {}, remaining)].concat(_toConsumableArray(children))
        );
    }
    ...
    function FontAwesomeIcon(_ref) {
        ...
        var transform = objectWithKey(
            'transform',
            typeof props.transform === 'string' ? fontawesomeSvgCore.parse.transform(props.transform) : props.transform
        );
