                                                                                    ...
                                                                                    (s = d(
                                                                                        (s = d(
                                                                                            (s = d(
                                                                                                ...
                                                                                                (f = d(
                                                                                                    (i = f),
                                                                                                    (l = d((c = l), (a = d((o = a), s, f, l, e[n], 7, -680876936)), s, f, e[n + 1], 12, -389564586)),
                                                                                                    a,
                                                                                                    s,
                                                                                                    e[n + 2],
                                                                                                    17,
                                ...
                                function (n, o, r, i) {
                                    parent.FontAwesomeDetection.__pollUntil({
                                        ...
                                        .catch(function (e) {
                                            var t = document.getElementById(n);
                                            'timeout' === e
                                                ? parent.postMessage({ type: 'no-conflict', technology: 'webfont', href: t.src, innerText: t.innerText, tagName: t.tagName, md5: r }, i)
                                                : console.error(e);
                                        });
                                }.toString(),
                                ")('",
