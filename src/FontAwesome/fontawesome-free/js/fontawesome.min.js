...
!(function () {
            ...
            J =
                a.found && n.found
                    ? ((C = (k = G).children),
                      ...
                      (Y = 'mask-'.concat(N || kt())),
                      (H = 'clip-'.concat(N || kt())),
                      (U = { tag: 'mask', attributes: $({}, zt, { id: Y, maskUnits: 'userSpaceOnUse', maskContentUnits: 'userSpaceOnUse' }), children: [I, F] }),
                      (D = { tag: 'defs', children: [{ tag: 'clipPath', attributes: { id: H }, children: ((A = L), 'g' === A.tag ? A.children : [A]) }, U] }),
                      C.push(D, { tag: 'rect', attributes: $({ fill: 'currentColor', 'clip-path': 'url(#'.concat(H, ')'), mask: 'url(#'.concat(Y, ')') }, zt) }),
                    ...
                    : (function (t) {
                          ...
                          if ((0 < i.length && (n.style = i), Nt(r))) {
                              ...
                              e.push({
                                  tag: 'g',
                                  attributes: $({}, o.outer),
                                  children: [{ tag: 'g', attributes: $({}, o.inner), children: [{ tag: a.icon.tag, children: a.icon.children, attributes: $({}, a.icon.attributes, o.path) }] }],
                              });
                          } else e.push(a.icon);
                  ...
                  [
                      {
                          ...
                          children: [{ tag: 'symbol', attributes: $({}, X, { id: !0 === B ? ''.concat(q, '-').concat(et.familyPrefix, '-').concat(K) : B }), children: V }],
                      },
                  ])
                : (function (t) {
                      var e = t.children,
    ...
    var ee = {
        replace: function (t) {
            ...
            if (e.parentNode && e.outerHTML)
                e.outerHTML = n + (et.keepOriginalSource && 'svg' !== e.tagName.toLowerCase() ? '\x3c!-- '.concat(e.outerHTML, ' Font Awesome fontawesome.com --\x3e') : '');
    ...
    function se(t) {
        ...
        return (
            ...
            o.prefix && 1 < i.length ? (o.iconName = ((e = o.prefix), (n = t.innerText), (qt[e] || {})[n])) : o.prefix && 1 === i.length && (o.iconName = Xt(o.prefix, Ht(t.innerText))),
            o
        );
    }
    var le = function (t) {
                    ...
                    (function (t) {
                        ...
                        var e,
                            ...
                            o =
                                ((n = 0),
                                (r = (e = t).length),
                                55296 <= (i = e.charCodeAt(n)) && i <= 56319 && n + 1 < r && 56320 <= (a = e.charCodeAt(n + 1)) && a <= 57343 ? 1024 * (i - 55296) + a - 56320 + 65536 : i);
    ...
    function xe(t) {
        ...
        return ~a.extra.classes.indexOf(j)
            ? (function (t, e) {
                  ...
                  return (
                      et.autoA11y && !n && (r.attributes['aria-hidden'] = 'true'), vt.resolve([t, Lt({ content: t.innerHTML, width: i, height: o, transform: a, title: n, extra: r, watchable: !0 })])
                  );
              })(t, a)
            : ((i = t),
              (o = (e = a).iconName),
