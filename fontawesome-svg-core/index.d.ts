...
export function layer(assembler: (addLayerCallback: (layerToAdd: IconOrText | IconOrText[]) => void) => void, params?: LayerParams): Layer;
...
export type SizeProp = 'xs' | 'lg' | 'sm' | '1x' | '2x' | '3x' | '4x' | '5x' | '6x' | '7x' | '8x' | '9x' | '10x';
